...
namespace CustomItemsClient.DataBlocks
{
    public class TPTwoDataBlock : ItemDataBlock
    {
        public TPTwoDataBlock()
        {
            ...
            texture.LoadImage(File.ReadAllBytes(RustBuster2016.API.Hooks.GameDirectory + "\\RB_Data\\CustomItems\\TPTwo.png"));
            iconTex = texture;
        ...
        {
            return "Instantly teleports you to Hangar!";
        }
        ...
        private sealed class ITEM_TYPE : TPTwo<TPTwoDataBlock>, IInventoryItem
        {
